      ...
      <div className="w-full max-w-[400px]">
        ...
        <div className="card">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {/* A full page load, not fetch: the OAuth handshake has to happen in the browser. */}
            <a href={authApi.googleUrl()} className="btn-secondary w-full justify-center gap-2">
